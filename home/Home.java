...
import Locators.BrowserSetup;
import browser.setup.Browser;
import excel.setup.*;
import locators.Locators;
import screenshot.setup.CaptureScreenshot;
...
public static void takeScreenshot() throws Exception {
			CaptureScreenshot.screenShot();    // invoking screenshot method of CaptureScreen class to capture the screenshot
		}
